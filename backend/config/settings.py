...
RAG_RETRIEVAL_BACKEND = get_env("RAG_RETRIEVAL_BACKEND", "native")
CHAT_RETRIEVAL_BACKEND = get_env("CHAT_RETRIEVAL_BACKEND", "lightrag")
GRAPH_BACKEND = get_env("GRAPH_BACKEND", "lightrag")
