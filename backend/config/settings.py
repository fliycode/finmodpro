...
RAG_RETRIEVAL_BACKEND = get_env("RAG_RETRIEVAL_BACKEND", "llamaindex")
CHAT_RETRIEVAL_BACKEND = get_env("CHAT_RETRIEVAL_BACKEND", "llamaindex")
...
GRAPH_BACKEND = get_env("GRAPH_BACKEND", "disabled")
LLAMAINDEX_STORAGE_DIR = Path(
    get_env("LLAMAINDEX_STORAGE_DIR", str(BASE_DIR / "storage" / "llamaindex"))
)
LLAMAINDEX_INDEX_ID = get_env("LLAMAINDEX_INDEX_ID", "knowledgebase_vector_index")
...
LIGHTRAG_GRAPH_STORAGE = get_env("LIGHTRAG_GRAPH_STORAGE", "NetworkXStorage")
LIGHTRAG_CHAT_RETRIEVAL_ENABLED = get_bool_env("LIGHTRAG_CHAT_RETRIEVAL_ENABLED", False)
LIGHTRAG_CHAT_MODE = get_env("LIGHTRAG_CHAT_MODE", "mix")
LIGHTRAG_CHAT_TOP_K = get_int_env("LIGHTRAG_CHAT_TOP_K", 5)
